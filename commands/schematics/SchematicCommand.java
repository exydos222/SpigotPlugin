...
public class SchematicCommand implements CommandExecutor {
    ...
    public boolean onCommand(final CommandSender sender, final Command command, final String label, final String[] args) {
    	...
    	case "save":
    	{
    		...
    		if (data.schematicPosition1 == null) {
    			sender.sendMessage("You have not set your first position.");
    			return true;
    		} else if (data.schematicPosition2 == null) {
    			sender.sendMessage("You have not set your second position.");
    			return true;
    		} else if (data.schematicPosition1.getWorld() != data.schematicPosition2.getWorld()) {
    			sender.sendMessage("These points are in seperate worlds.");
    			return true;
    		}
    		SchematicOperator.createSchematic(args[1], data.schematicPosition1, data.schematicPosition2).saveSchematic();
